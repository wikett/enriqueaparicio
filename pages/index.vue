<template>
  <div
    ...
    <p class="border-2 border-pink-600">Bacon ipsum dolor amet andouille ham pork chop, porchetta ground round chicken
      strip steak meatball venison short ribs. Kielbasa fatback corned beef, ball tip boudin burgdoggen salami chicken
      pork belly landjaeger venison brisket pork chop. Buffalo fatback frankfurter ball tip salami bacon corned beef
      ground round prosciutto strip steak chicken. Prosciutto turkey alcatra meatball.</p>
    <span class="border-2 border-indigo-600">Probando el span</span>
    <h1 class="invisible border-1 border-black sm:visible">&lt;640px</h1>
    <h1 class="invisible border-1 border-black md:visible">&lt;768px</h1>
    <h1 class="invisible border-1 border-black lg:visible">&lt;1024px</h1>
    <h1 class="invisible border-1 border-black xl:visible">&lt;1280px</h1>
    <!-- <h2 class="text-3xl">Probando el titulo dos</h2>
    <h3 class="text-2xl">y ahora probando el titulo tres</h3>
    <p>esto es un paragrafo</p>
    <span class="text-xs">y esto de aqui un span</span> -->
